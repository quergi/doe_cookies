...
\text{Durchsch\_Durchmesser} = 71,771 - 1,583 \cdot \text{Block\_1} + 0,117 \cdot \text{Block\_2}  \\
    ...
    - 0,646 \cdot (\text{Zucker}\cdot\text{Vollkornmehl}) + 0,312 \cdot (\text{Butter}\cdot\text{Zucker}\cdot\text{Vollkornmehl})  \\
...
\begin{subfigure}{0.49\textwidth}
    ...
    \caption{Residuen in Abhängigkeit der Durchlaufnummern und damit Blechpositionen}
...
Diese Beobachtungen sind auf die Blechpositonen zurückzuführen.
...
Durch die Vereinfachung weichen nur die Prognosen für die Durchlaufnummern 1 als \emph{ungewöhnliche Beobachtung} ausgewiesen.
Die Residuenanalyse ergibt keine Hinweise auf Änderungen in der Normalverteilung, Streuung oder in der Ablaufstruktur.
...
Allerdings hat wird ein Durchlauf mehr als \emph{ungewöhnliche Beobachtung} ausgewiesen (siehe Abbildung \ref{fig:vereinfachung_3})
...
Im nächsten Schritt nun die 2FWW \emph{Butter*Zucker} entfernt.
