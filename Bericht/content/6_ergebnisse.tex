...
% Analyse des vollständigen Modells
\paragraph{Analyse des vollständigen Modells}
% ToDo Block und Zentralpunkt
Eine Varianzanalyse des vollständigen Modells identifiziert Faktoren mit kaum signifikanten Effekten.
So sind alle 2FFW und die 3FFW liegen über dem Signifikanznivaue $\alpha = 0,05$.
