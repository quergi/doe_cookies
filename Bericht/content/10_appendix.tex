...
Dies sind die Rezepte mit den Mengenangaben. Zur Vereinheitlichung wurde Packpulver mit dem Faktor $0,75$ in Natron umgerechnet.
Zudem wurden sämtliche Zutaten, die als Füllung gedacht sind mit SchokoSt bezeichnet.
Zucker jeglicher Art (raffiniert, braun oder Vanillezucker) wurde zu Zucker hinzugezählt.
War bei den Zutaten von einem Eigelb die Rede wird dieses als halbes Ei mit Faktor $0,5$ gewertet.  
...
\begin{figure}[H]
    ...
    \caption{Variierende Cookie-Durchmesser aus dem Vorversuch mit unregelmäßigen Stücken von einer weißen Schokoladentafel und Cranberries.}
...
\begin{subfigure}{0.49\textwidth}
    ...
    \label{fig:portionierung_wiegen}
\end{subfigure}\hfill
\begin{subfigure}{0.49\textwidth}
    \centering
