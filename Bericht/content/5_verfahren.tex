...
Auf ihr liegt immer eine Cookie für den Zentralpunkt, der so unter konstanten Randbedingungen liegt.
...
Der Erste ist die Zubereitung der Teige für alle neun FSK und die Zentralpunkte, der Zweite das Backen und Messen der Cookies.
...
Zum Schluss des ersten Teilprozesses befinden sich zehn Teige im Kühlschrank.
...
Der Teig wird dabei bündig zur Kante des EP abgezogen (siehe Abbildung \ref{fig:portionierung_wiegen}).
...
und in der dritten Replikation 20 abgezogen, um auf die Position zu kommen.
...
\input{tables/zubereitung.tex}

% Aufwandabschätzung
\paragraph{Die Aufwandabschätzung} für das Experiment ergibt folgendes.
Die Zubereitung eines Teigs dauert circa 4,5\,Minuten, für zehn Teige also 45\,Minuten.
Zusätzlich muss der Mischtopf zehn mal gereinigt und getrocknet werden.
...
Die Cookie-Portionierung wird mit anschließender Reinigung des Protionierers auf 1\,Minute geschätzt.
...
Pro Replikation werden rund 1\,Stunde für den zweiten Teilprozess und 2,5\,Stunden im Gesamten benötigt.
Der Aufwand für das Gesamte Experiment liegt damit bei 7,5\,Stunden verteilt auf sechs Tage.
...
% Durchführung
\paragraph{Die Durchführung} fand an drei aufeinander folgenden Wochenenden statt.
Je ein Wochenende für eine Replikation.
Die Teigrohlinge und die Cookies nach dem Backen sind im Anhang \ref{ch:appendix_durchf} dokumentiert.
Die Raum- und Kühlschranktemperaturen sind die der Tabelle \ref{table:temperaturen} dokumentiert.

\input{tables/temperaturen.tex}

Bei der zweiten und dritten Replikationen liefen zwei Cookies ineinander (siehe Abbildungen \ref{fig:block2_3_nacher} und \ref{fig:block3_4_nacher})
Dies wirkte sich glücklicherweise wenig auf die Form und Ausdehnung aus.
Die Messung der betroffenen Cookies erfolgte so, dass die Kontaktstellen möglichst zwischen den Messpunkten lag.
Während des Portionierens wurden die Teigrohling kurzzeitig im Kühlschrank gelagert, um eine ungleiche Erwärmung des Teigs auszuschließen.
Dies ist in der Abbildung \ref{fig:kühlung} im Anhang \ref{ch:appendix_durchf} dokumentiert.
Die Cookies hatten dabei die Position, die sie auf dem Backblech einnehmen werden.